        ...
        <StatusBar barStyle="light-content"/>
           ...
           <Title color="light" variant="big" bold>
            ...
            <Text align="center" spacing="0px 40px"> 
                Stay on top of the fashion world and your favorite looks. </Text>
           </Box>
            <Box align="center" fluid justify="flex-end">
            <Button block onPress={() => navigation.navigate('Signin')}>
                <Text color="light">SinIg my account</Text>
            </Button>
            <Spacer size="30px"/>
            <Text underline color="light" onPress={() => navigation.navigate('Signup')}>
                Create new account
            </Text>
            </Box>
       </Box>
